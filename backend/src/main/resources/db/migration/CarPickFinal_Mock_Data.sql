...
INSERT INTO CAR_SPEC (
    ...
    use_yn, deleted_at
      ...
      ('KIA','Kia Sportage 2.0','BLUE','스포티지','SUV',2024,'패밀리 SUV로 공간성과 주행 안정성이 강점입니다.','GASOLINE','AUTO',TRUE,'네비게이션,후방카메라,차선보조,통풍시트,블루투스',21,1,5,'SUV 적재 공간 넓음','복합 10~12km/L','http://carpicka.mycafe24.com/car_spin_video/car_suv_sportage_blue_spin.mp4','http://carpicka.mycafe24.com/car_thumbnail/car_suv_sportage_blue_thumb.png','SUV,패밀리,장거리,공간','가솔린,SUV,패밀리,장거리','Y',NULL),
      ('HYUNDAI','Hyundai IONIQ 5','WHITE','아이오닉5','RV',2024,'전기차 특유의 정숙성과 넓은 실내, 빠른 충전이 장점입니다.','ELECTRIC','AUTO',FALSE,'네비게이션,후방카메라,차선보조,스마트크루즈,블루투스',21,1,5,'EV 적재 공간 여유','전비 4~5km/kWh','http://carpicka.mycafe24.com/car_spin_video/car_rv_ioniq5_white_spin.mp4','http://carpicka.mycafe24.com/car_thumbnail/car_rv_ioniq5_white_thumb.png','전기차,EV,정숙,충전,미래지향','전기,EV,정숙,장거리','Y',NULL),
      ('TESLA','Tesla Model Y','BLACK','테슬라','IMPORT',2023,'전기차 특유의 가속력과 넓은 실내 공간을 갖춘 수입 EV SUV입니다.','ELECTRIC','AUTO',FALSE,'오토파일럿,네비게이션,후방카메라,블루투스,OTA업데이트',21,2,5,'SUV 트렁크/프렁크','전비 5~6km/kWh','http://carpicka.mycafe24.com/car_spin_video/car_suv_modelY_black_spin.mp4','http://carpicka.mycafe24.com/car_thumbnail/car_suv_modelY_black_thumb.png','테슬라,전기차,SUV,수입,오토파일럿,EV','전기,EV,SUV,패밀리','Y',NULL);
